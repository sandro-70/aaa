...
public class log extends javax.swing.JFrame {
    ...
    public static Game_menu gamemenu=new Game_menu();
    ...
    public void verificarUser(){
        ...
        users encontrado=userExistente(user,password);
        if(encontrado!=null){
            gamemenu.setUsers(username,encontrado );
    ...
    public users userExistente(String user,String password){
        for(int i=0;i<username.size();i++){
            users username= this.username.get(i);
            String User= username.getName();
            String clave= username.getPassword();
            if(User.equals(user)&&clave.equals(password)){
                return username;}
